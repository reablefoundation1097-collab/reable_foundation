...
export class Programs implements OnInit, OnDestroy {
  ...
  programs = [
    ...
    },
    {
      ...
      desc: 'Promoting inclusive learning environments with trained educators, adapted curricula, and equal educational opportunities for every learner.',
    ...
    },
    {
      ...
      desc: 'Skills development and vocational programs that open pathways to sustainable employment and economic independence.',
      items: ['Computer & digital skills', 'Artisan & craft training', 'Business entrepreneurship', 'Job placement support', 'Corporate sensitization workshops'],
